...
public class PointBarChartActivity extends Activity implements OnChartValueSelectedListener {
	// Debug
	private static final	String		TAG 	= "PointBarChartActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_pointcard_freq);
    ...
    private void setData() {
    	...
    	Cursor cursor = mDB.getConnection().query(Constants.TABLE_NAMES[Constants.POINT],
    											  Constants.COLUMS,
